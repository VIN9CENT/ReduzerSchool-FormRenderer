...
export default function PricingSection() {
 return (
   <section className="w-full min-h-screen bg-white/95 backdrop-blur-sm rounded-[25px] overflow-hidden">
     {/* Banner */}
     ...
     <div className="w-full px-6 py-12 md:px-12 lg:px-24 xl:px-32">
       <div className="max-w-5xl mx-auto space-y-8">
         ...
         <div className="bg-white rounded-2xl shadow-md p-8 md:p-10 text-center">
           <h2 className="font-serif font-bold text-[#111] text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight">
             Investment in Your{" "}
         ...
         <div className="bg-white rounded-2xl shadow-md p-8 md:p-10 flex flex-col items-center text-center gap-4 hover:shadow-lg transition-all duration-300">
           ...
           <h3 className="font-black text-[#d92b2b] text-2xl sm:text-3xl md:text-4xl lg:text-5xl uppercase tracking-wide leading-tight">
             Monthly Plan
           </h3>

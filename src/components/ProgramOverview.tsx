    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-red-600 rounded-2xl p-10 flex flex-col items-center text-center hover:bg-red-700 transition-colors duration-200">
            <Clock className="text-white w-10 h-10 mb-4" />
            <p className="text-red-200 text-sm font-medium uppercase tracking-widest mb-2">
              Course Duration
            </p>
            <p className="text-white text-3xl font-bold">52 Weeks</p>
          </div>
          ...
          <div className="bg-red-600 rounded-2xl p-10 flex flex-col items-center text-center hover:bg-red-700 transition-colors duration-200">
            ...
            <p className="text-white text-3xl font-bold">Mon-Fri • 8am-5pm</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-red-600 rounded-2xl p-10 flex flex-col items-center text-center hover:bg-red-700 transition-colors duration-200">
            ...
            <p className="text-white text-3xl font-bold">Kisii, Kenya</p>
          </div>
          ...
          <div className="bg-red-600 rounded-2xl p-10 flex flex-col items-center text-center hover:bg-red-700 transition-colors duration-200">
            ...
            <p className="text-white text-3xl font-bold">September 1st 2026</p>
          </div>
        </div>

        <div className="bg-red-600 rounded-2xl p-10 flex flex-col items-center text-center mb-12 hover:bg-red-700 transition-colors duration-200">
          ...
          {skillsOpen && (
            <ul className="px-10 pb-8 space-y-3 border-t border-gray-100 pt-6">
              {skills.map((skill, i) => (
                ...
                >
                  <span className="text-red-600 font-bold mt-0.5 shrink-0 text-lg">
                    •
                  </span>
                  {skill}
                </li>
        ...
        >
          ...
          <a
            href="/curriculum.pdf"
            download
            className="flex items-center gap-3 bg-red-600 hover:bg-red-700 transition-colors duration-200 text-white font-bold text-base px-8 py-4 rounded-full whitespace-nowrap"
          >
        ...
        <div className="flex justify-center">
          <Link
            href="#apply"
            className="flex items-center gap-3 bg-red-600 hover:bg-black transition-colors duration-200 text-white font-bold text-lg px-14 py-5 rounded-full"
          >
            Apply Now

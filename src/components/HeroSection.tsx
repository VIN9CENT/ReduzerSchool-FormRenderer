    ...
    <section className="relative w-full overflow-hidden bg-[#F7F9FB]">
      ...
      <div className="relative flex flex-col items-center pt-20 md:pt-28 lg:pt-[160px] gap-16 md:gap-[120px] pb-16">
        ...
        <div className="flex flex-col items-center gap-8 md:gap-12 w-full max-w-[896px] px-6">
          {/* Heading */}
          <h1 className="font-['Inter sans-serif'] font-bold text-4xl sm:text-5xl lg:text-[64px] leading-tight lg:leading-[85px] tracking-[-1px] lg:tracking-[-2.56px] text-center text-[#191C1E] max-w-[986px] w-full">
            Launch Your{' '}
          ...
          {/* Subtitle */}
          <p className="font-['Inter sans-serif'] font-normal text-lg md:text-xl lg:text-[24px] leading-[1.5] lg:leading-[32px] tracking-[-0.2px] text-center text-[#5F3E3C] max-w-[560px]">
            Hands-on training, mentorship, and real-world projects built for
            ambitious learners ready to break into tech.
          </p>

          {/* Intake label */}
          <p className="font-['Inter sans-serif'] font-semibold text-[13px] md:text-[14px] leading-[12px] tracking-[1.2px] text-center uppercase text-[#565E74]">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-[30px] w-full pt-4 pb-10 md:pb-[49.1px]">
            ...
            >
              <span className="font-['Inter sans-serif'] font-semibold text-[18px] leading-[28px] tracking-[1.8px] text-center text-white">
                Apply Now
              </span>
            ...
            >
              <span className="font-['Inter sans-serif'] font-semibold text-[18px] leading-[28px] tracking-[1.8px] text-center text-[#BB001F]">
                View Curriculum
              </span>
            </Link>
          </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-4 justify-items-center">
              {features.map(({ icon: Icon, label }) => (
                <div key={label} className="flex flex-col items-center gap-4">
                  ...
                  <span className="font-['Inter sans-serif'] font-semibold text-[12px] leading-[12px] tracking-[1.2px] text-center text-[#191C1E]">
                    {label}
                  </span>
                </div>
              ))}

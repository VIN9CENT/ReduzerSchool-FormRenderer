      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-5 text-gray-300 text-2xl leading-relaxed">
              Innovating Today.
              <br />
          ...
          <div>
            ...
            <div className="space-y-8 text-2xl">
              ...
              <a href="https://wa.me/254709090889" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 ">
                <FaWhatsapp className="text-red-500 w-5 h-5 shrink-0" />
                <span>+254709090889</span>
              </a>
              <a href="mailto:contact@ReduzerSchool.tech" className="flex items-start gap-4 ">
                <MdOutlineMail className="text-red-500 w-5 h-5 mt-2 shrink-0" />
                <span className="break-all">contact@ReduzerSchool.tech</span>
              </a>
            </div>
          </div>
          ...
          {/* LEGALS */}
          <div>
            <h2 className="text-2xl font-bold uppercase">Legals</h2>
            <div className="w-28 border-b border-red-500 mt-4 mb-8"></div>
            <ul className="space-y-8 text-2xl text-gray-200">
              <li>
          ...
          {/* PROGRAM */}
          <div>
            <h2 className="text-2xl font-bold uppercase">Program</h2>
            <div className="w-28 border-b border-red-500 mt-4 mb-8"></div>
            <ul className="space-y-8 text-2xl text-gray-200">
              <li>
        ...
        {/* COPYRIGHT */}
        <p className="text-xl text-gray-300 mt-10 c">
